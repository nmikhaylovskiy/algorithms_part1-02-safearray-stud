 ...
 *
 *  Большинство полей класса представлены в открытой области, т.к.
 *  у нас нет необходимости
 *  в их инкапсуляции в силу простоты задачи. В этом смысле класс
 *  подобен обычным структурам.
 *
...
public:
    ...
    *
    *  Создается в стеке (локально), несмотря на использования
     *  оператора =. Признак локальности
